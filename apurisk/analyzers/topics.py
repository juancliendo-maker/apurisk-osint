...
CATEGORIAS_TEMAS = {
    ...
    "seguridad": [
        "homicidio", "homicidios", "asesinato",
        "extorsión", "extorsion", "extorsionista",
        "sicariato", "sicario",
        "narco", "narcotráfico", "narcotrafico",
        "inseguridad", "inseguridad ciudadana", "ola de inseguridad",
        "delincuencia", "criminalidad",
        "crimen organizado",
        "banda criminal", "bandas criminales",
        "robo", "asalto", "secuestro",
        "minería ilegal", "mineria ilegal",
        "raqueteo", "marcaje",
        "cobro de cupos", "cupos",
    ],
    "electoral": [
